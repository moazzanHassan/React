  ...
  return (
    <div style={{padding:"10px 15px"}} className='w-[300px] h-full bg-sky-500 rounded-3xl flex-nowrap shrink-0'>
          ...
          <div style={{marginTop : "20px"}} className='flex justify-between '>
            <button style={{padding : "5px 5px 5px 5px"}} className='bg-green-500 text-sm'>Mark as Completed</button>
            <button style={{padding : "5px 5px 5px 5px"}} className='bg-red-500 text-sm'>Mark as Failed</button>
          </div>
        </div>
  )
}
