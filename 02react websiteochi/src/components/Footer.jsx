...
function Footer() {
  return (
    <div className='w-full h-[110vh] px-10 md:px-16 pt-10 flex flex-col md:flex-row'>
            <div className='w-full md:w-1/2  md:h-full  font-[fot] font-semibold flex  flex-col justify-between md:pb-3'>
                <div className='text'>
                <h1 className='text-[10vw] leading-none  md:-mb-10 uppercase'>Eye-</h1>
                <h1 className='text-[10vw] uppercase'>Opening</h1>
                </div>
                <div className='svg hidden md:block'>
            ...
            <div className='w-full md:w-1/2 h-full flex flex-col justify-between pb-3'>
            <div className='top'>
            <h1 className='text-[10vw] leading-none font-[fot] font-semibold uppercase'>Presentations</h1>
            <div className='mt-16'>
                <ul className='list-none font-[new] font-semibol leading-7 '>
                <li><a className='pb-[.5] border-b-[1px]' href="#">Instagram</a></li>
                <li><a className='pb-[.5] border-b-[1px]' href="#">Behance</a></li>
                <li><a className='pb-[.5] border-b-[1px]' href="#">Facebook</a></li>
                <li><a className='pb-[.5] border-b-[1px]' href="#">Linkedin</a></li>
                </ul>
            </div>
            </div>
            <div className='bot'>
                <h4 className='opacity-[.6]'>© Moazzan redesign 2024. Legal Terms</h4>
            </div>
            </div>
    </div>
  )
