...
function Footer() {
  return (
    <div className='w-full h-[110vh] px-16 pt-10 flex'>
            <div className='w-1/2 h-full  font-[fot] font-semibold flex flex-col justify-between pb-3'>
                <div className='text'>
                <h1 className='text-[10vw] leading-none -mb-10 uppercase'>Eye-</h1>
            ...
            <div className='w-1/2 h-full flex flex-col justify-between pb-3'>
            <div className='top'>
            ...
            <div className='bot'>
                <h4 className='opacity-[.6]'>© ochi design 2024. Legal Terms</h4>
            </div>
            </div>
    </div>
  )
